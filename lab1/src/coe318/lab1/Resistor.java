...
//FIX THIS so that it returns the actual voltage
        VoltageValue = CurrentValue*ResistorValue;
...
if(voltage>=-50 && voltage<=50){
    ...
    System.out.println("Value not within parameter!");
}
...
if(VoltageValue == 0){
    ...
    CurrentValue = VoltageValue/ResistorValue;
}
...
if(current>=-5 && current<=5){
    ...
    System.out.println("Value not within parameters!");
}
